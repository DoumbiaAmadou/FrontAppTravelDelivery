...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    setResult(
      "un problème interne est survenu veillez réessayer plutard s'il vous plait"
    );
  };
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      <p className="text-center h3 fw-bold mb-5 mx-1 mx-md-4 mt-4">
                        Bienvenue sur la page d'incription!{" "}
                      </p>
                      ...
                      >
                        ...
                        <div className="form-floating mb-3">
                          <input
                            ...
                            placeholder="Ville:"
                          />
                          <label className="form-label" htmlFor="form3City1c">
                            Ville:
                          </label>
                          <small className="text-danger d-block">
                            {errors.city?.message}
                        ...
                        <div className="form-floating mb-3">
                          ...
                          />
                          <label className="form-label" htmlFor="form3Phone1c">
                            Téléphone:
                          </label>
                          <small className="text-danger d-block">
