...
const Cart = ({ cart, updateItem, removeItem }) => {
  ...
  const handleChange = (e, element) => {
    ...
    if (e.target.value < 1) return removeItem(element);
    let value = e.target.value;

    if (typeof element[e.target.name] === "number") value = parseInt(value);
  ...
  const handleValidation = async (e) => {
    ...
    if (!error) history.push("/ConfirmReservation");
  };
        ...
        <div className="row no-gutters">
          <div className="col-md-12">
                    ...
                    <div className="d-flex flex-row">
                      ...
                      <span className="align-middle kilo ">
                        ...
                        {element.avalaiblekilos &&
                          element.avalaiblekilos + " Kg (max)"}
                      </span>
                    </div>
                    <div className="d-flex flex-row align-items-center">
                      <span className="d-block ms-5 fw-bold">
                        € {(element.quantity * element.kiloPrice).toFixed(2)}
                      </span>
                      &nbsp;
                      <i
            ...
            <div className="d-flex flex-row  align-content-end">
              <button
                className="mt-4 ml-auto p-2 btn btn-warning"
